...
class DailyEntryModel extends DailyEntryEntity {
  ...
  factory DailyEntryModel.fromEntity(DailyEntryEntity e) => DailyEntryModel(
        ...
        leaveOnToday: e.leaveOnToday,
        leaveEnabledAt: e.leaveEnabledAt,
  ...
  factory DailyEntryModel.fromFirestore(Map<String, dynamic> map, String id) {
    ...
    return DailyEntryModel(
      ...
      leaveOnToday: map[FirebaseConstants.leaveOnToday] as bool? ?? false,
      leaveEnabledAt: (map[FirebaseConstants.leaveEnabledAt] as dynamic)?.toDate(),
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      FirebaseConstants.leaveOnToday: leaveOnToday,
      if (leaveEnabledAt != null) FirebaseConstants.leaveEnabledAt: leaveEnabledAt,
